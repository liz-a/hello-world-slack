...
class GuessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guess" do
    assert_difference('Guess.count') do
      post guesses_url, params: { guess: { correct_or_incorrect: @guess.correct_or_incorrect, game_id: @guess.game_id, guess: @guess.guess } }
    end
  ...
  test "should update guess" do
    patch guess_url(@guess), params: { guess: { correct_or_incorrect: @guess.correct_or_incorrect, game_id: @guess.game_id, guess: @guess.guess } }
